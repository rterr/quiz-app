var questionOne = {
		...
		correctAnswer: 2,
  	options: ['Marios Bros.', 'Donkey Kong', 'Balloon Fight', 'Marble Madness'],
...
var questionTwo = {
		...
		trivia: 'Bowser is named Koopa in Japan.',
};
...
var questionThree = {
		...
		trivia: 'The Goomba’s Japanese name, Kuribo, means \“chestnut.\”',
};
...
var questionEight = {
		...
		trivia: 'All the seven Koopalings are named after famous musicians, and they first appeared in Super Mario Bros. 3 (Nintendo Entertainment System, 1988).',
};
...
var questionTen = {
		questionNumber: 10,
		question: 'What was Princess Peach\’s official name in North America prior to Mario 64?',
		correctAnswer: 2,
